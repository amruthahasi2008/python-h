...
for j in quiz_scores:
    for k in quiz_scores:
        pair_step = pair_step + 1

print("Total Pair Checks:", pair_step)
...
worst_case_score = 88
print("Best Case Target:", best_case_score)
print("Average Case Target:", average_case_score)
print("Worst Case Target:", worst_case_score)
